...
export const spanish: I18nTranslations = {
  ...
  PROJECTS: {
    MUEBLES_DESCRIPTION:
      "Sala de exposición de muebles para clientes que quieren ver el trabajo realizado.",
    CUENTAS_FARMACIA_DESCRIPTION:
      "Una aplicación web para gestionar las cuentas de una farmacia. Tiene los productos con precio y un panel de control con fechas para gestionar las cuentas.",
    UNIT_CONVERTER_DESCRIPTION:
      "Una aplicación web para convertir unidades del sistema estadounidense al métrico.",
